...
seeder.connect('mongodb+srv://gilangrmdhn13:bwamern@cluster0.r83w0.mongodb.net/db_staycation?retryWrites=true&w=majority', {
  ...
  seeder.clearModels(['Category', 'Bank', 'Item', 'Feature', 'Activity', 'Member', 'Image', 'Booking', 'Users'], function () {
